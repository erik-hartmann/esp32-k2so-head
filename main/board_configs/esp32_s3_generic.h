// Placeholder for a future ESP32-S3 board. BLE only (no BT Classic) — still
...
#define BOARD_NAME "ESP32-S3 (unconfigured placeholder)"
#define BOARD_HAS_BT_CLASSIC 0

#define LED_STRIP_COUNT 1
#define LED_STRIP_GPIOS { 5 }        // TODO: verify against your S3 board's pinout
